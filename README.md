...
и количестве товара в категории; магические методы: __ str __ , реализован метод, который подсчитывает средний ценник 
всех товаров
...
класса Product, реализован миксин-класс для вывода сообщения создания объекта в консоль, обаботана ошибка добавления 
продкута с 0 количеством
